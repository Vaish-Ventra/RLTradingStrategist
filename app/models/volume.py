...
model = xgb.XGBRegressor(objective='reg:squarederror', n_estimators=400, learning_rate=0.2, max_depth=4, subsample=0.9, colsample_bytree=0.9)
...
with open("models/btc_stats_volume.json", "w") as f:
    json.dump(stats, f)